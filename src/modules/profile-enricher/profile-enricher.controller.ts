...
export class ProfileEnricherController {
  constructor(private readonly profileEnricherService: ProfileEnricherService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateProfileEnricherDto: UpdateProfileEnricherDto) {
